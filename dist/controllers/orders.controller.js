...
exports.deleteOneOrder =
  exports.updateOneOrder =
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const newOrder = new Order_model_1.default(
        Object.assign(Object.assign({}, orderData), {
          date: date,
          total: total,
      ...
      if (currentClient.orders) {
        ...
        if (populatedClient) {
          const currentTurn = yield Turn_model_1.default.findById(
            orderData.turn_id
          );
          if (!currentTurn) {
...
const updateOneOrder = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const orderUpdated = yield Order_model_1.default.findByIdAndUpdate(
        orderId,
        newOrderInfo
      );
      if (!orderUpdated) {
